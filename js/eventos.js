...
$('#BtnIngresa').click(function () {
 ...
 $('#txt-articulo').focusout(function() {
       ...
       /*
       $.ajax({url: "http://189.198.138.158:7010/api/articulos/"+ articulo, success: function(resultado){
...
*/
      //alert(articulo);
                          ...
                          $.ajax({
                            url: "http://189.198.138.158:7010/api/articulos/"+ articulo,
    ...
    var boleta= $('#txt-boleta').val(); 
       ...
       else
       {
         var objetoarticulo =  
            ...
            $.ajax({type: "POST",  url: "http://189.198.138.158:7010/api/articulos/", contentType: "application/json; charset=utf-8",
